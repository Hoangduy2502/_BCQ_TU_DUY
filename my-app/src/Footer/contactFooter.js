            ...
            <div id="contact" className="contactFooter container">
                ...
                <div className="contact-body">
                    ...
                    <div className="like-facebook col-2 col-xl-5">
                        <div className="fb-page" data-href="https://www.facebook.com/banhcuonquyenhaiphong/" data-tabs="" data-width="300px" data-height="100%" data-small-header="false" data-adapt-container-width="false" data-hide-cover="false" data-show-facepile="false"><blockquote cite="https://www.facebook.com/banhcuonquyenhaiphong/" className="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/banhcuonquyenhaiphong/">BÁNH CUỐN QUYÊN</a></blockquote></div>
