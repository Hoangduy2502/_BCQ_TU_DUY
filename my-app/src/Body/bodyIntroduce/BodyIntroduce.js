            ...
            <div className="row">
                ...
                <div className="col-md-4 Footerimg">
                    <div className="col2-Footer">
                        ...
                        <img className="footerimg2" src={footerimg2}></img>
            ...
            <div className="container-fluid p-0 section3-intro" >
                ...
                <div className="container ">
                    ...
                    <div className="row fourthP-section3">
                        ...
                        <span style={{textAlign:"center"}} className="col-md-8">Hơn 70 năm tồn tại và phát triển, Bánh cuốn Quyên tự hào đi cùng lịch sử thành phố Hải Phòng xuyên suốt 3 thế hệ. Gánh bánh cuốn nhỏ mưu sinh ngày ấy nay đã trở thành tiệm ăn khang trang tiếp nối cơ nghiệp của gia đình, và đĩa bánh cuốn ngon miệng ngày nào nay cũng thấm đẫm những câu chuyện về văn hoá, lịch sử. Để rồi người dân Hải Phòng không ai là không biết, hay cả những người yêu ẩm thực từ những vùng miền khác khi đến với Hải Phòng đều ít nhiều từng nghe tới Bánh cuốn Quyên.</span>
                    </div>
                </div>
